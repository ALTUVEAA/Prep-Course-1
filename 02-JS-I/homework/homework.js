...
const nuevaString = "Holammmmmmmmmmmmmmm";
...
function obtenerAreaRectangulo(alto, ancho) {
  ...
  // Tu código:
  areaDeRentangulo = alto * ancho;
  return areaDeRentangulo;
}
...
function esVocal(letra) {
  ...
  for (let vocal of letra.toLowerCase()) {
